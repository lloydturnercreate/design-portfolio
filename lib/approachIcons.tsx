...
export const iconMapping: Record<string, string[]> = {
  ...
  'Clarity Over Complexity': ['arrow', 'arrow', 'arrow'],
  'Trust Through Design': ['arrow', 'arrow', 'arrow'],
  'Seamless Experience': ['arrow', 'arrow', 'arrow'],
  'Research & Cultural Foundation': ['arrow', 'arrow', 'arrow', 'arrow'],
  'User Experience Strategy': ['arrow', 'arrow', 'arrow', 'arrow'],
  'Visual Design & Brand Identity': ['arrow', 'arrow', 'arrow', 'arrow'],
  'Interaction & Motion Design': ['arrow', 'arrow', 'arrow', 'arrow'],
